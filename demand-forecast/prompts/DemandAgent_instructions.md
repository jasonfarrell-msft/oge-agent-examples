...
You first get the current weather by calling the `GetCurrentDemand` function.
...
The final energy need will be the need_per_household multiplied by numberOfCustomers value returned by `GetCurrentDemandData`